...
# 3. 训练策略配置(schedules) =========================================
lr_config = dict(
    lr=1e-4, type="cosine", warmup_iters=500, warmup_ratio=0.01, backbone_lr_rate=0.3
)
...
log_interval = 50
load_from = "/home/dmmm/VscodeProject/FPI/checkpoints/CCN_Dimension/CCN_384to384.py/output/net_best.pth"
resume_from = None
debug = True
seed = 666
