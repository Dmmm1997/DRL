...
model = dict(
    backbone=dict(
        ...
        pretrain_path="/home/dmmm/VscodeProject/FPI/pretrain_model/mixformer_tracking_pretrain_base_patch16.pth",
        pretrain=True,
        output_index=[0],
    ),
    neck=dict(
    ...
    head=dict(type="ChannelPooling", head_pool="avg", input_dim=128),
    postprocess=dict(
